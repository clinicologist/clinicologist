...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.registrationnoController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.userRegistrationNo, ''));
    _model.registrationnoFocusNode ??= FocusNode();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) => TextFormField(
                          controller: _model.registrationnoController,
                          focusNode: _model.registrationnoFocusNode,
                          textCapitalization: TextCapitalization.words,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Your Registration',
                            labelStyle:
                                FlutterFlowTheme.of(context).labelMedium,
                            hintStyle: FlutterFlowTheme.of(context).labelMedium,
                            enabledBorder: OutlineInputBorder(
                          ...
                          style: FlutterFlowTheme.of(context).bodyMedium,
                          validator: _model.registrationnoControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await currentUserReference!
                              ...
                              userRegistrationNo:
                                  _model.registrationnoController.text,
                              userHospital: _model.hospitalnameController.text,
