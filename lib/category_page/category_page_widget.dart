...
class CategoryPageWidget extends StatefulWidget {
  const CategoryPageWidget({
    super.key,
    required this.fieldtocategory,
  });

  final MedicalFieldRecord? fieldtocategory;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              alignment: AlignmentDirectional(-1.0, 0.0),
                              child: Text(
                                'New cancer research and treatment advancements',
                                style: FlutterFlowTheme.of(context).bodyMedium,
                              ),
                            ),
                          ],
                  ...
                  Container(
                    ...
                    child: StreamBuilder<List<CnfRecord>>(
                      stream: queryCnfRecord(
                        queryBuilder: (cnfRecord) => cnfRecord.where(
                          'C_field',
                          isEqualTo: widget.fieldtocategory?.reference,
                        ),
                      ),
                      builder: (context, snapshot) {
                        ...
                        List<CnfRecord> listViewCnfRecordList = snapshot.data!;
