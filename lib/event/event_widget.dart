...
class EventWidget extends StatefulWidget {
  const EventWidget({
    super.key,
    required this.hometoevent,
  });

  final CnfRecord? hometoevent;
    ...
    return Title(
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              top: true,
              child: StreamBuilder<CnfRecord>(
                stream: CnfRecord.getDocument(widget.hometoevent!.reference),
                builder: (context, snapshot) {
                  ...
                  final parentColumnCnfRecord = snapshot.data!;
                  return Column(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed(
                              'DetailsForm',
                              queryParameters: {
                                'eventtodetails': serializeParam(
                                  parentColumnCnfRecord,
                                  ParamType.Document,
                                ),
                              }.withoutNulls,
                              extra: <String, dynamic>{
                                'eventtodetails': parentColumnCnfRecord,
                              },
                            );
                          },
                          child: Container(
